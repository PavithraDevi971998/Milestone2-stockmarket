	...
	<div class="bord">
		...
		<form:form method="POST" action="/addEmployee" modelAttribute="e1">
			...
			<tr>
				...
				<br>
				<form:errors path="company_name" class="text-danger" /></tr>
			
			<tr>
				<th>TurnOver:</th>
				<td><form:input path="turnOver" type="text" /></td>
				<br>
				<form:errors path="turnOver" class="text-danger" /></tr>
			
			<tr>
				<th>Ceo:</th>
				<td><form:input path="ceo" type="text" /></td>
				<br>
			...
			<tr>
				...
				<td><form:input path="boardOfDirectors" type="text" /></td>
				<br>
				<form:errors path="boardOfDirectors" class="text-danger" />
			</tr>
			<tr>
				<th>Sectorid:</th>
				<td><form:input path="sectorid" type="text" /></td>
				<br>
			</tr>
			<form:errors path="sectorid" class="text-danger" />
			<tr>
				<th>briefWriteup:</th>
				<td><form:input path="briefWriteup" type="text" /></td>
				<br>
			</tr>
